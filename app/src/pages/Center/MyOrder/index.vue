    ...
    <div class="order-right">
        <div class="order-content">
                ...
                <table class="order-item" v-for="record in myOrder.records" :key="record.id">
                    ...
                    <tbody>
                        <tr v-for="order,index in record.orderDetailList" :key="order.id">
                            ...
                            <td :rowspan="record.orderDetailList.length" width="8%" class="center" v-if="index===0">{{record.consignee}}</td>
            ...
            <div class="choose-order">
                <Pagination ref="pagination" :pageSize="pageSize" :pageNo="pageNo" :total="myOrder.total" :continues="continues" />
            </div>
        </div>
        <!--猜你喜欢-->
        <div class="like">
